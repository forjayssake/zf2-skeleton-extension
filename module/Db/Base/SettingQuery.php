 ...
 * @method     ChildSettingQuery orderByvalueInt($order = Criteria::ASC) Order by the valueInt column
 * @method     ChildSettingQuery orderByvalueString($order = Criteria::ASC) Order by the valueString column
 * @method     ChildSettingQuery orderByvalueFloat($order = Criteria::ASC) Order by the valueFloat column
 * @method     ChildSettingQuery orderByvalueBool($order = Criteria::ASC) Order by the valueBool column
 ...
 * @method     ChildSettingQuery groupByvalueInt() Group by the valueInt column
 * @method     ChildSettingQuery groupByvalueString() Group by the valueString column
 * @method     ChildSettingQuery groupByvalueFloat() Group by the valueFloat column
 * @method     ChildSettingQuery groupByvalueBool() Group by the valueBool column
 ...
 * @method     ChildSetting findOneByvalueInt(int $valueInt) Return the first ChildSetting filtered by the valueInt column
 * @method     ChildSetting findOneByvalueString(string $valueString) Return the first ChildSetting filtered by the valueString column
 * @method     ChildSetting findOneByvalueFloat(string $valueFloat) Return the first ChildSetting filtered by the valueFloat column
 * @method     ChildSetting findOneByvalueBool(boolean $valueBool) Return the first ChildSetting filtered by the valueBool column
 * @method     ChildSetting findOneByCreatedAt(string $created_at) Return the first ChildSetting filtered by the created_at column
 * @method     ChildSetting findOneByUpdatedAt(string $updated_at) Return the first ChildSetting filtered by the updated_at column *
 ...
 * @method     ChildSetting requireOneByvalueInt(int $valueInt) Return the first ChildSetting filtered by the valueInt column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSetting requireOneByvalueString(string $valueString) Return the first ChildSetting filtered by the valueString column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSetting requireOneByvalueFloat(string $valueFloat) Return the first ChildSetting filtered by the valueFloat column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSetting requireOneByvalueBool(boolean $valueBool) Return the first ChildSetting filtered by the valueBool column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSetting[]|ObjectCollection findByvalueInt(int $valueInt) Return ChildSetting objects filtered by the valueInt column
 * @method     ChildSetting[]|ObjectCollection findByvalueString(string $valueString) Return ChildSetting objects filtered by the valueString column
 * @method     ChildSetting[]|ObjectCollection findByvalueFloat(string $valueFloat) Return ChildSetting objects filtered by the valueFloat column
 * @method     ChildSetting[]|ObjectCollection findByvalueBool(boolean $valueBool) Return ChildSetting objects filtered by the valueBool column
 * @method     ChildSetting[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSetting objects filtered by the created_at column
 * @method     ChildSetting[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSetting objects filtered by the updated_at column
...
abstract class SettingQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\SettingQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Setting', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, valueInt, valueString, valueFloat, valueBool, created_at, updated_at FROM settings WHERE id = :p0';
        try {
    ...
    public function filterByvalueInt($valueInt = null, $comparison = null)
    {
        if (is_array($valueInt)) {
            ...
            if (isset($valueInt['min'])) {
                $this->addUsingAlias(SettingTableMap::COL_VALUEINT, $valueInt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($valueInt['max'])) {
                $this->addUsingAlias(SettingTableMap::COL_VALUEINT, $valueInt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SettingTableMap::COL_VALUEINT, $valueInt, $comparison);
    }

    /**
     * Filter the query on the valueString column
     *
     * Example usage:
     * <code>
     * $query->filterByvalueString('fooValue');   // WHERE valueString = 'fooValue'
     * $query->filterByvalueString('%fooValue%'); // WHERE valueString LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByvalueString($valueString = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SettingTableMap::COL_VALUESTRING, $valueString, $comparison);
    }
    ...
    public function filterByvalueFloat($valueFloat = null, $comparison = null)
    {
        if (is_array($valueFloat)) {
            ...
            if (isset($valueFloat['min'])) {
                $this->addUsingAlias(SettingTableMap::COL_VALUEFLOAT, $valueFloat['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($valueFloat['max'])) {
                $this->addUsingAlias(SettingTableMap::COL_VALUEFLOAT, $valueFloat['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SettingTableMap::COL_VALUEFLOAT, $valueFloat, $comparison);
    }

    /**
     * Filter the query on the valueBool column
     *
     * Example usage:
     * <code>
     * $query->filterByvalueBool(true); // WHERE valueBool = true
     * $query->filterByvalueBool('yes'); // WHERE valueBool = true
     * </code>
     *
    ...
    public function filterByvalueBool($valueBool = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SettingTableMap::COL_VALUEBOOL, $valueBool, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SettingTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SettingTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(SettingTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SettingTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SettingTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SettingTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SettingTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SettingTableMap::COL_CREATED_AT);
    }
