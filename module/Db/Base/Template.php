...
/**
 * Base class that represents a row from the 'templates' table.
 *
 * 
 *
...
abstract class Template implements ActiveRecordInterface 
{
    ...
    public function setname($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[TemplateTableMap::COL_NAME] = true;
        }
    ...
    public function setevent($v)
    {
        ...
        if ($this->event !== $v) {
            $this->event = $v;
            $this->modifiedColumns[TemplateTableMap::COL_EVENT] = true;
        }
    ...
    public function setsubject($v)
    {
        ...
        if ($this->subject !== $v) {
            $this->subject = $v;
            $this->modifiedColumns[TemplateTableMap::COL_SUBJECT] = true;
        }
    ...
    public function setbody($v)
    {
        ...
        if ($this->body !== $v) {
            $this->body = $v;
            $this->modifiedColumns[TemplateTableMap::COL_BODY] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[TemplateTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[TemplateTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TemplateTableMap::translateFieldName('name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TemplateTableMap::translateFieldName('event', TableMap::TYPE_PHPNAME, $indexType)];
            $this->event = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TemplateTableMap::translateFieldName('subject', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subject = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TemplateTableMap::translateFieldName('body', TableMap::TYPE_PHPNAME, $indexType)];
            $this->body = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TemplateTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TemplateTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = TemplateTableMap::NUM_HYDRATE_COLUMNS.
        ...
        $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                if ($this->archiveOnDelete) {
                    // do nothing yet. The object will be archived later when calling ChildTemplateQuery::delete().
                } else {
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(TemplateTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(TemplateTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(TemplateTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TemplateTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(TemplateTableMap::COL_EVENT)) {
            $modifiedColumns[':p' . $index++]  = 'event';
        }
        if ($this->isColumnModified(TemplateTableMap::COL_SUBJECT)) {
            $modifiedColumns[':p' . $index++]  = 'subject';
        }
        if ($this->isColumnModified(TemplateTableMap::COL_BODY)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TemplateTableMap::COL_NAME)) {
            $criteria->add(TemplateTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(TemplateTableMap::COL_EVENT)) {
            $criteria->add(TemplateTableMap::COL_EVENT, $this->event);
        }
        if ($this->isColumnModified(TemplateTableMap::COL_SUBJECT)) {
            $criteria->add(TemplateTableMap::COL_SUBJECT, $this->subject);
        }
        if ($this->isColumnModified(TemplateTableMap::COL_BODY)) {
            $criteria->add(TemplateTableMap::COL_BODY, $this->body);
        }
        if ($this->isColumnModified(TemplateTableMap::COL_CREATED_AT)) {
            $criteria->add(TemplateTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(TemplateTableMap::COL_UPDATED_AT)) {
            $criteria->add(TemplateTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     *
     * @return     $this|ChildTemplate The current object (for fluent API support)
     */
     ...
     *
     * @return     ChildTemplatesArchive An archive object, or null if the current object was never archived
     */
    public function getArchive(ConnectionInterface $con = null)
    {
        ...
        $archive = ChildTemplatesArchiveQuery::create()
            ->filterByPrimaryKey($this->getPrimaryKey())
            ->findOne($con);
     ...
     *
     * @return     ChildTemplatesArchive The archive object based on this object
     */
    public function archive(ConnectionInterface $con = null)
    {
        ...
        if (!$archive) {
            $archive = new ChildTemplatesArchive();
     ...
     *
     * @param      ChildTemplatesArchive $archive An archived object based on the same class
    ...
    public function populateFromArchive($archive, $populateAutoIncrementPrimaryKeys = false) {
        ...
        $this->setevent($archive->getevent());
