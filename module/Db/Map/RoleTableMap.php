...
class RoleTableMap extends TableMap
{
     ...
     */
    const COL__ROLE_ID = 'roles._role_id';
     ...
     */
    const COL_ISDEFAULT = 'roles.isDefault';
    ...
    /**
     * the column name for the constant field
     */
    const COL_CONSTANT = 'roles.constant';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('id', '_role_id', 'name', 'isDefault', 'description', 'constant', ),
        self::TYPE_CAMELNAME     => array('id', '_role_id', 'name', 'isDefault', 'description', 'constant', ),
        self::TYPE_COLNAME       => array(RoleTableMap::COL_ID, RoleTableMap::COL__ROLE_ID, RoleTableMap::COL_NAME, RoleTableMap::COL_ISDEFAULT, RoleTableMap::COL_DESCRIPTION, RoleTableMap::COL_CONSTANT, ),
        self::TYPE_FIELDNAME     => array('id', '_role_id', 'name', 'isDefault', 'description', 'constant', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('id' => 0, '_role_id' => 1, 'name' => 2, 'isDefault' => 3, 'description' => 4, 'constant' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, '_role_id' => 1, 'name' => 2, 'isDefault' => 3, 'description' => 4, 'constant' => 5, ),
        self::TYPE_COLNAME       => array(RoleTableMap::COL_ID => 0, RoleTableMap::COL__ROLE_ID => 1, RoleTableMap::COL_NAME => 2, RoleTableMap::COL_ISDEFAULT => 3, RoleTableMap::COL_DESCRIPTION => 4, RoleTableMap::COL_CONSTANT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, '_role_id' => 1, 'name' => 2, 'isDefault' => 3, 'description' => 4, 'constant' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('_role_id', '_role_id', 'INTEGER', 'roles', 'id', false, null, null);
        $this->addColumn('name', 'name', 'VARCHAR', true, 100, null);
        $this->addColumn('isDefault', 'isDefault', 'BOOLEAN', false, 1, false);
        $this->addColumn('description', 'description', 'LONGVARCHAR', false, null, null);
        $this->addColumn('constant', 'constant', 'VARCHAR', false, 100, null);
    } // initialize()
    ...
    {
        $this->addRelation('parentRole', '\\Role', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':_role_id',
    1 => ':id',
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('RoleRelatedByid', '\\Role', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':_role_id',
    1 => ':id',
  ),
), null, null, 'RolesRelatedByid', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RoleTableMap::COL__ROLE_ID);
            $criteria->addSelectColumn(RoleTableMap::COL_NAME);
            $criteria->addSelectColumn(RoleTableMap::COL_ISDEFAULT);
            $criteria->addSelectColumn(RoleTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(RoleTableMap::COL_CONSTANT);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.constant');
        }
    }
