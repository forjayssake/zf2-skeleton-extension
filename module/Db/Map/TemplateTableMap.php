...
class TemplateTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'templates.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'templates.name';

    /**
     * the column name for the event field
     */
    const COL_EVENT = 'templates.event';

    /**
     * the column name for the subject field
     */
    const COL_SUBJECT = 'templates.subject';

    /**
     * the column name for the body field
     */
    const COL_BODY = 'templates.body';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'templates.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'templates.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('id', 'name', 'event', 'subject', 'body', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'event', 'subject', 'body', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(TemplateTableMap::COL_ID, TemplateTableMap::COL_NAME, TemplateTableMap::COL_EVENT, TemplateTableMap::COL_SUBJECT, TemplateTableMap::COL_BODY, TemplateTableMap::COL_CREATED_AT, TemplateTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'event', 'subject', 'body', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('id' => 0, 'name' => 1, 'event' => 2, 'subject' => 3, 'body' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'event' => 2, 'subject' => 3, 'body' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(TemplateTableMap::COL_ID => 0, TemplateTableMap::COL_NAME => 1, TemplateTableMap::COL_EVENT => 2, TemplateTableMap::COL_SUBJECT => 3, TemplateTableMap::COL_BODY => 4, TemplateTableMap::COL_CREATED_AT => 5, TemplateTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'event' => 2, 'subject' => 3, 'body' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TemplateTableMap::COL_NAME);
            $criteria->addSelectColumn(TemplateTableMap::COL_EVENT);
            $criteria->addSelectColumn(TemplateTableMap::COL_SUBJECT);
            $criteria->addSelectColumn(TemplateTableMap::COL_BODY);
            $criteria->addSelectColumn(TemplateTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(TemplateTableMap::COL_UPDATED_AT);
        } else {
